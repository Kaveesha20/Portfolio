          ...
          <div className="max-w-3xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <motion.a
                ...
                className="bg-surface p-6 rounded-lg text-center hover:shadow-xl transition-shadow"
                whileHover={{ y: -5 }}
              >
                ...
                <p className="text-foreground-muted text-sm">kaveeshanirmani25@gmail.com</p>
              </motion.a>
              ...
              >
                ...
                <p className="text-foreground-muted text-sm">kaveesha-nirmani-795671242</p>
              </motion.a>
            ...
            <div className="bg-surface p-8 rounded-lg">
              ...
              <form className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-3 bg-primary hover:bg-primary-dark text-background rounded-lg font-semibold transition-colors"
                >
                  Send Message
                </button>
              </form>

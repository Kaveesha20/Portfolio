          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <motion.div
                ...
                className="bg-surface p-6 rounded-lg hover:shadow-xl transition-shadow flex flex-col"
              >
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.techTags.map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1 bg-surface-alt text-foreground-muted text-sm rounded-full"
                    >
                      {tag}
                    </span>
                  ))}
